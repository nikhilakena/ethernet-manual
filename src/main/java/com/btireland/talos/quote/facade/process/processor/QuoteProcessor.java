...
public class QuoteProcessor {
    ...
    public QBTDCOrderResponse createQuote(QBTDCOrder qbtdcOrderRequest, String oao)
        ...
        try {
            ...
            LOGGER.error("create quote request {}", createQuoteRequest);
    ...
    public QBTDCOrderResponseDTO createQBTDCQuote(QuoteOrderMapEntity quoteOrderMap, CreateQuoteRequest createQuoteRequest) throws PersistanceException {
        ...
        try {
            ...
            if (!(CollectionUtils.isEmpty(createQuoteResponse.getQuotes()))) {
                ...
                QuoteOrder quoteOrder = OrderManagerRequestMapper.createOrderManagerRequest(createQuoteResponse, quoteOrderMap);
                LOGGER.error("order manager request. {}", quoteOrder);
    ...
    private CreateQuoteResponse createQuote(CreateQuoteRequest createQuoteRequest) {
        ...
        try {
            ...
            LOGGER.error("Failed to create quote: {}", ex.getMessage(), ex);
        ...
        LOGGER.error("create quote res {}", createQuoteResponse);
    ...
    LOGGER.error("Quote Order Request to be saved in WAG DB {}", quoteOrderRequest);
