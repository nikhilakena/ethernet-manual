...
@Component
public class SendQuoteDelayedEmailServiceTask extends ServiceTask<QuoteProcessVariables> implements JavaDelegate {

    private final QuoteWorkflowProcessor quoteWorkflowProcessor;

    public SendQuoteDelayedEmailServiceTask(QuoteWorkflowProcessor quoteWorkflowProcessor) {
