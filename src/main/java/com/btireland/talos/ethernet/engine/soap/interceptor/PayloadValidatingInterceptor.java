...
import com.btireland.talos.ethernet.engine.soap.SoapConstants;
...
public class PayloadValidatingInterceptor extends AbstractFaultCreatingValidatingInterceptor {
    ...
    protected boolean handleRequestValidationErrors(MessageContext messageContext, SAXParseException[] errors) {
        ...
        if (messageContext.getResponse() instanceof SoapMessage) {
            ...
            var fault = body.addClientOrSenderFault(getFaultStringOrReason(), getFaultStringOrReasonLocale());
