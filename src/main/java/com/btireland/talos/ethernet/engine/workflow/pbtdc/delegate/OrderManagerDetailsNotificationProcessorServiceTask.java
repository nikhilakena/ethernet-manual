...
@Slf4j
@Component(value = "processOrderManagerDetNotificationServiceTask")
public class OrderManagerDetailsNotificationProcessorServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PbtdcNotificationProcessorService pbtdcNotificationProcessorService;

    public OrderManagerDetailsNotificationProcessorServiceTask(PbtdcNotificationProcessorService pbtdcNotificationProcessorService) {
    ...
    public void executeTask(long orderId, PbtdcOrderProcessVariables processVariables) throws Exception {
        ...
        pbtdcNotificationProcessorService.processOrderManagerDetailsNotification(orderId, processVariables.getParkedNotificationId());
    }
