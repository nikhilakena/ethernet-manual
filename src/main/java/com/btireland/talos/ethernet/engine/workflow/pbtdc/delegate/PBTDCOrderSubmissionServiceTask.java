...
@Slf4j
@Component(value = "sendOrderServiceTask")
public class PBTDCOrderSubmissionServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public PBTDCOrderSubmissionServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService) {
