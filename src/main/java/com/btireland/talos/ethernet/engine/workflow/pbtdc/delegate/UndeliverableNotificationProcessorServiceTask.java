...
@Slf4j
@Component(value = "processPbtdcUndeliverableNotificationServiceTask")
public class UndeliverableNotificationProcessorServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PbtdcNotificationProcessorService pbtdcNotificationProcessorService;

    public UndeliverableNotificationProcessorServiceTask(PbtdcNotificationProcessorService pbtdcNotificationProcessorService) {
    ...
    public void executeTask(long orderId, PbtdcOrderProcessVariables processVariables) throws Exception {
        ...
        pbtdcNotificationProcessorService.processUndeliverable(orderId, processVariables.getParkedNotificationId());
    }
