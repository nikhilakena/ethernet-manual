...
@Slf4j
@Component
public class SendCustomerDelayStartNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendCustomerDelayStartNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService){
    ...
    public void executeTask(long orderId, PbtdcOrderProcessVariables processVariables) throws Exception {
        pbtdcOrderWorkflowService.sendDelayStartNotification(orderId);
