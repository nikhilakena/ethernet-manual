...
@Slf4j
@Component
public class SendUndeliverableNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendUndeliverableNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService) {
    ...
    public void executeTask(long orderId, PbtdcOrderProcessVariables processVariables) throws Exception {
        pbtdcOrderWorkflowService.processUndeliveredNotification(orderId);
    }
