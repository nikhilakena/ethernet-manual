...
@Slf4j
@Component
public class SendNotesNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendNotesNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService){
