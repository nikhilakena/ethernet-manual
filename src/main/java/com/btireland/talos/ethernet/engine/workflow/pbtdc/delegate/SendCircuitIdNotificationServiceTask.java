...
@Slf4j
@Component
public class SendCircuitIdNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendCircuitIdNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService){
