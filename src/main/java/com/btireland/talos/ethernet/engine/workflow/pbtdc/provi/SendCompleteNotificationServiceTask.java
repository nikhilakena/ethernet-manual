...
@Slf4j
@Component
public class SendCompleteNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendCompleteNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService){
