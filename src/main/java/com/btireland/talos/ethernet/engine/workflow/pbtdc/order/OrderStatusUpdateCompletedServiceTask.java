...
@Slf4j
@Component
public class OrderStatusUpdateCompletedServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public OrderStatusUpdateCompletedServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService) {
