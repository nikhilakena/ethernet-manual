...
@Slf4j
@Component
public class SendConfirmationNotificationServiceTask extends ServiceTask<PbtdcOrderProcessVariables> implements JavaDelegate {

    private PBTDCOrderWorkflowService pbtdcOrderWorkflowService;

    public SendConfirmationNotificationServiceTask(PBTDCOrderWorkflowService pbtdcOrderWorkflowService){
